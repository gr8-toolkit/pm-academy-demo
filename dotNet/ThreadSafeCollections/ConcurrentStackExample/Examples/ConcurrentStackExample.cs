...
namespace ConcurrentStackExamples.Examples
{
    public static class ConcurrentStackExample
    {
        ...
        static ConcurrentStack<string?> _storage = new ConcurrentStack<string?>();
        ...
        {
            var sb = new StringBuilder();
            while (_storage.TryPop(out string? value))
            {
